...
export default function Welcome() {
  return (
    <section className="bg-td-beige w-full">
      <div className="flex flex-col lg:flex-row gap-y-10 px-4 py-10 lg:px-12 lg:py-16 xl:py-32 lg:gap-x-8 max-w-content mx-auto">
        <div
          className={cn(
            "lg:w-1/2 font-bold text-[52px] md:text-[64px] xl:text-[80px] lg:tracking-normal leading-[0.8]",
            kobe.className,
          )}
        >
        ...
        <div className="lg:w-1/2">
          <p className="text-sm lg:text-base mb-10 font-normal lg:leading-tight tracking-tight">
